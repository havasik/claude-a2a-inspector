...
All input responses SHALL be sent as standard `send_message` socket events with the ARK `input-response` envelope embedded as a DataPart in the message. No new socket event types are introduced.
